...
export function TaskDetail({ task: initialTask, onClose }: TaskDetailProps) {
  ...
  const handleDateChange = (
    field: 'startDate' | 'expectedEndDate' | 'actualEndDate',
    date: Date | undefined,
  ) => {
    if (date) {
          ...
          <TabsContent value="details" className="space-y-4 pt-4">
                    ...
                    <Popover open={startDateOpen} onOpenChange={setStartDateOpen}>
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          selected={
                            task.startDate
                              ? new Date(task.startDate.replace(/\//g, '-'))
                              : undefined
                          }
                  ...
                  <div className="relative">
                    <Popover open={expectedDateOpen} onOpenChange={setExpectedDateOpen}>
                      <PopoverTrigger asChild>
                        <div
                          className="cursor-pointer"
                          onClick={() => handleDateClick('expectedEndDate')}
                        >
                          <Button
                            variant={'outline'}
                            className={cn(
                        ...
                        <Calendar
                          ...
                          selected={
                            task.expectedEndDate
                              ? new Date(task.expectedEndDate.replace(/\//g, '-'))
                              : undefined
                          }
                  ...
                  <div className="relative">
                    <Popover open={actualDateOpen} onOpenChange={setActualDateOpen}>
                      <PopoverTrigger asChild>
                        <div
                          className="cursor-pointer"
                          onClick={() => handleDateClick('actualEndDate')}
                        >
                          <Button
                            variant={'outline'}
                            className={cn(
                      ...
                      <PopoverContent className="w-auto p-0" align="start">
                        <Calendar
                          ...
                          selected={
                            task.actualEndDate
                              ? new Date(task.actualEndDate.replace(/\//g, '-'))
                              : undefined
                          }
            ...
            <div className="space-y-2">
              ...
              {isEditing ? (
                ...
                <div className="p-3 bg-gray-50 rounded-md border text-sm whitespace-pre-line">
                  {task.summary}
                </div>
              )}
            </div>
          ...
          <TabsContent value="history" className="space-y-4 pt-4">
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <div className="text-sm">
                    <span className="font-medium">周北河</span> 将任务状态从{' '}
                    <Badge variant="outline">待开始</Badge> 更改为{' '}
                    <Badge
                      variant="outline"
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <div className="text-sm">
                    <span className="font-medium">徐小夕</span> 将任务分配给{' '}
                    <span className="font-medium">周北河</span>
                  </div>
