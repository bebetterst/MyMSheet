          ...
          <TabsContent value="overview" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    较上月 {allTasks.length > 10 ? '+5' : '+2'} 个任务
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {allTasks.filter((task) => task.status === '进行中').length}
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    占总任务{' '}
                    {Math.round(
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    完成{' '}
                    {
                      allTasks.filter((task) => task.priority === '重要紧急' && task.completed)
                        .length
                    }{' '}
                    个
                  </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    共 {Object.keys(assigneeCounts).length} 名成员
                  </p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {Math.max(...Object.values(assigneeCounts))} 个任务
                  </div>
                  <p className="text-xs text-gray-500 mt-1">
                    ...
                    <Bar
                      data={{
                        ...
                        datasets: [
                          {
                            label: '完成率 (%)',
                            data: Object.keys(assigneeCounts).map(
                ...
                <CardContent>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                    <div
                      ...
                      style={{
                        width: `${Math.round(((priorityCounts['重要紧急'] || 0) / allTasks.length) * 100)}%`,
                      }}
                    ></div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                    <div
                      className="bg-yellow-500 h-2.5 rounded-full"
                      style={{
                        width: `${Math.round(((priorityCounts['重要不紧急'] || 0) / allTasks.length) * 100)}%`,
                      }}
                    ></div>
                  </div>
                </CardContent>
                ...
                <CardContent>
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                    <div
                      ...
                      style={{
                        width: `${Math.round(((priorityCounts['紧急不重要'] || 0) / allTasks.length) * 100)}%`,
                      }}
                    ></div>
                  </div>
                </CardContent>
