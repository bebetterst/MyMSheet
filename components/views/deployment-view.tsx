      ...
      <div className="p-6 space-y-6">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button>
              <a href="https://mindlink.turntip.cn" target="_blank">
                AI文档编辑器
              </a>
            </Button>
          </div>
                ...
                {isDeploying && (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      {deploymentProgress}% -{' '}
                      {deploymentProgress < 100 ? '正在部署...' : '部署完成'}
                    </p>
                  </div>
                )}
              </CardContent>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-700">
                        部署完成后，访问 http://服务器IP 即可打开多维表格。默认管理员账号为
                        admin，密码为 admin123，请在首次登录后立即修改密码。
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-900 text-gray-100 p-3 rounded-md font-mono text-sm relative">
                    <pre>
                      kubectl apply -f https://example.com/multitable/mongodb.yaml -n multitable
                    </pre>
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-900 text-gray-100 p-3 rounded-md font-mono text-sm relative">
                    <pre>
                      kubectl apply -f https://example.com/multitable/deployment.yaml -n multitable
                    </pre>
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-900 text-gray-100 p-3 rounded-md font-mono text-sm relative">
                    <pre>
                      kubectl apply -f https://example.com/multitable/service.yaml -n multitable
                    </pre>
                    <Button
                      variant="ghost"
                      size="icon"
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex justify-center">
                        <div className="bg-white p-2 rounded-md border border-blue-200 w-36 h-36 flex items-center justify-center">
                          <span className="text-xs text-gray-500">
                            <img
                              src="https://flowmix.turntip.cn/fm/static/logo.ce1bcd6a.jpeg"
                              alt=""
                            />
                          </span>
                        </div>
                        <div className="bg-white ml-6 p-2 rounded-md border border-blue-200 w-36 h-36 flex items-center justify-center">
                          <span className="text-xs text-gray-500">
                            <img
